    ...
    ?>
       ...
       <form method="POST" enctype="multipart/form-data">
         ...
         <div class="form-group">
           ...
           <div class="row">
             <div class="col-xs-12">
               <img width="75" src="dimg/admins/<?php echo $row['admins_file']; ?>" alt="">
             </div>
           </div>
         </div>
         ...
         <div class="form-group">
           ...
           <div class="row">
             <div class="col-xs-12">
               <select class="form-control" name="admins_status" value="<?php echo $row['admins_status']; ?>">
        ...
        <input type="hidden" name="delete_file" value="<?php echo $row['admins_file']; ?>">
         ...
         <div align="right" class="box-footer">
           <button type="submit" class="btn btn-success" name="admin_update">duzenle</button>
         </div>
